...
#     response = self.client.post(reverse("authors:login"), {'email': User.email, 'password': 'test1234'})
#     print("Response: ", dir(response))
#     self.assertEqual(response.status_code, 200)

#   def test_view_all_authors(self):
#     response = self.client.get(reverse("authors:user"))
...
#         response = self.client.get(reverse('authors:user-detail', kwargs={'pk': user_id}))
#         self.assertNotEqual(response.status_code, 200)
#         # Check for redirect or forbidden response
