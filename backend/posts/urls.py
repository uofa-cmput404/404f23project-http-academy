...
urlpatterns = [
    ...
    path('<str:pk>/categories/', views.categories_list), # GET all categories for a post, POST a new category
    path('categories/<str:pk>', views.category_detail), # GET a specific category, DELETE a category, PATCH a category
]
