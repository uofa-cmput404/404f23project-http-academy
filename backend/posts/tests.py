...
class PostTests(TestCase):
    ...
    def test_get_all_comments_for_post(self):
        ...
        second_response = self.client.get(reverse("posts:comments_list", args=[1]))
        self.assertEqual(len(second_response.data), 1)
    ...
    def test_get_specific_comment(self):
        ...
        response = self.client.get(reverse("posts:comment_detail", args=[1]))
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_image(self):
        ...
        Post.objects.create(author=self.user, title="Test Post", content="Test Content", image=base64, unlisted=True)
        response = self.client.get(reverse("posts:get_post_image", args=[1]))
        self.assertEqual(response.status_code, 200)
